...
class ConnectionFactoryTest {
    ...
    void buildJdbcUrlProducesExpectedFormat() {
        DatabaseConfigurationProperties config = new DatabaseConfigurationProperties("db.local", 1433, "femsq", null, "alex", "secret", "credentials", null);
    ...
    private static class StubConfigurationService extends DatabaseConfigurationService {
        ...
        public DatabaseConfigurationProperties loadConfig() {
            return new DatabaseConfigurationProperties("stub.local", 1433, "femsq", null, "alex", "secret", "credentials", null);
        }
    }
}
