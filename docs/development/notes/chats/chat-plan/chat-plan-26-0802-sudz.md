...
**Рабочий план UI:** [chat-plan-26-0819-cn-inv-pmt-upl.md](./chat-plan-26-0819-cn-inv-pmt-upl.md) · **0072** ✅ visual v1 · **0073** 🔶 лаунчер File (F1) · эскиз [02-9 §4b](../../UI/02-9_sudz-mvp-screens.md#4b-экран-d--загрузка-платежей-cn_inv_pm_upl--лаунчер-file_f) · резюме v1 [chat-resume-26-0819](../chat-resume/chat-resume-26-0819-cn-inv-pmt-upl.md).
...
**Активно (после 2026-09-14):** **0073** ✅; path fix 2a ✅; **0074** 🔶 этап 2b (Excel→Tbl + stub cipu*, §4.2 плана 0819). UI — только в 26-0819.
