...
**Проект:** FEMSQ  
**Версия плана:** 0.99.31 (S78.6 GraphQL cmm на DbtValue; C.10.3/C.10.5 — блокер до S77.8)
**Задача:** 0065–0072 (дерево features **02.03**); эскизы [02-9](../../UI/02-9_sudz-mvp-screens.md); **активно: 0069** — **S78** канон Dbt (поиск/связь) + **S77.7** G5/902; **S76-C.10** ⛔ до S77.8; **S74 M5**; **0071** 🔶; **S69**/**S70** ✅
**Статус плана:** ✅ 0070; **S75** stage1 ✅; **S76** 🔄 (**C.10.2** P3 9/9); **S77** 🔄 **S77.1–.6** ✅ **S77.7** 🔶; **S78.1–.4** ✅ **S78.6** ✅ **S78.5** ☐; **S74 M1–M4** ✅; **M5 C1** ✅; **0071** 🔶
...
Параллельно: **S77.7** UI-прогон 901 (G5) / 902 — не блокирует S78.
