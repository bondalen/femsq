...
**Задача:** 0069 · **План:** [chat-plan-26-0802-sudz.md](chats/chat-plan/chat-plan-26-0802-sudz.md) §5.6 S76-C  
...
Порядок **пошагового** UAT воронки `runSudzDbtUplFunnel` — в UI и **без UI** (GraphQL/curl, CI, агент).  
