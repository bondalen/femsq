...
**Текущий канон UAT (2026-09-07):** upl **901** = Excel **X** (`…31.12.2025 … -НОВЫЙ.xlsx`); затем **902** (QI НОВЫЙ); эталон Rslt QI = `ags_Yr_DbtChangesRslt_26-0505.xlsx`. Хвост «добить G2 на старом 902» **не** продолжать — рестарт с C.10.0.
