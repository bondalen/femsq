...
/****** Object:  StoredProcedure [ags].[spMstrg_2408_SaveToTables_ipgSt]    Script Date: 16.04.2026 12:04:33 ******/
SET ANSI_NULLS ON
GO
...
-- ������ ���������������� ���������
CREATE PROCEDURE [ags].[spMstrg_2408_SaveToTables_ipgSt]
    @ipgCh			int,
    @MounthEndDate	date,
	@ipgSt			nvarchar(255)
AS
BEGIN
    ...
    PRINT '������ ���������� ���������: ' + CONVERT(nvarchar(50), @StartTime, 121);
    PRINT '���������: @ipgCh = ' + CAST(@ipgCh AS nvarchar(10)) + ', @MounthEndDate = ' + CONVERT(nvarchar(50), @MounthEndDate, 23);
    PRINT '';
    ...
    PRINT @StepName + ' ��������� �� ' + CAST(DATEDIFF(MILLISECOND, @StepTime, SYSDATETIME()) AS nvarchar(20)) + ' ��';
    PRINT '';
    ...
    select * from ags.fnIpgChRsltCstUtlPercentBrn_2408_ipgSt(@ipgCh, @ipgSt); --ags.fnIpgChRsltCstUtlPercentBrn_2408(@ipgCh);
    
    DECLARE @RecordCount int;
    SELECT @RecordCount = COUNT(*) FROM @TableFnIpgChRsltCstUtlPercentBrn_2408;
    
    PRINT @StepName + ' ��������� �� ' + CAST(DATEDIFF(MILLISECOND, @StepTime, SYSDATETIME()) AS nvarchar(20)) + ' ��';
    PRINT '������� � ��������� �������: ' + CAST(@RecordCount AS nvarchar(20));
    PRINT '';
    ...
    -- ��������� 3: ������� ��� ��������� ag_, iv_, ia_ (np_, uk_, oh_ � �����)
    SET @StepTime = SYSDATETIME();
    SET @StepName = '���������� ���������� 3 (������� ��� ag_, iv_, ia_)';
    PRINT @StepName + '...';
    ...
    -- ��������� 4: ������ �� @TableFnIpgChRsltCstUtlPercentBrnRep01_2408 (� JOIN ��� ��������, ����������� � ��������������� �������)
    SET @StepTime = SYSDATETIME();
    SET @StepName = '���������� ���������� 4 (������ � JOIN ��� ��� �������)';
    PRINT @StepName + '...';
    ...
    SELECT 
        ...
        , z.iv_lim, z.uk_lim
        , CASE WHEN z.ag_lim > 0 THEN '���������' WHEN z.iv_lim > 0 THEN '������.' ELSE '������' END AS ipgSh
        -- ������� ����� ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    FROM
        (
            ...
            SELECT 
                ...
                CASE WHEN za.cstAgPnCode = '�����' AND za.branch = 0 THEN 1 ELSE 0 END AS wr,
            ...
            WHERE CASE WHEN za.cstAgPnCode = '�����' AND za.branch = 0 THEN 1 ELSE 0 END = 0
            -- ������� ����� ==================================================================================================================================
        ) as z
        LEFT JOIN 
            ( 
                ...
                FROM
                    (
                        SELECT 
                            ISNULL(p.ogNm, '�����') AS ogNm, p.branch, p.branchName, 
                            ISNULL(p.cstAgPnCode, '�����') AS cstAgPnCode, CASE WHEN p.ag_PlAccum = 0 THEN NULL ELSE p.ag_PlAccum END AS ag_PlAccum, 
                            CASE WHEN p.ag_PlFulfillment = 0 THEN NULL ELSE p.ag_PlFulfillment END AS ag_PlFulfillment, 
                            p.ag_PlPercentMinusOverFulf AS ag_PlPz,
                            CASE WHEN p.ag_PlOverFulfillment = 0 THEN NULL ELSE p.ag_PlOverFulfillment END AS ag_PlOverFulfillment, p.ag_PlPercent, 
                            p.ag_Pl AS ag_Pl_M, p.ag_acceptedTtl AS ag_acceptedTtl_M, 
                ...
                WHERE CASE WHEN zb.cstAgPnCode = '�����' AND zb.branch = 0 THEN 1 ELSE 0 END = 0
                -- �������������� �����. ��������� ========================================================================================================
        ...
        LEFT JOIN 
            (
                ...
                WHERE CASE WHEN zc.cstAgPnCode = '�����' AND zc.branch = 0 THEN 1 ELSE 0 END = 0
                -- ��� ������ �����. ��������� ============================================================================================================
    ...
    -- ��������� 5: ������ �� @TableFnIpgChRsltCstUtlPercentBrnRep01_2408 � ����������� WHERE cstAgPnCode = '�����' � UNION
    SET @StepTime = SYSDATETIME();
    SET @StepName = '���������� ���������� 5 (������ � ����������� "�����" � UNION)';
    PRINT @StepName + '...';
    
    INSERT INTO ags.spMstrg_2408_ResultSet5
    SELECT  
        -- ����� ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        CASE WHEN o.ogNm = '�����' THEN '�' ELSE o.ipgSh END as ipgSh, lmm.lim as limSort
        , CASE WHEN o.branchName IS NULL THEN o.ogNm ELSE NULL END as ogNm, CASE WHEN o.branchName=o.ogNm THEN '����������� ����' ELSE o.branchName END as branchName,  o.lim, o.ag_lim
        , o.cstAgPnCode -- �������� ��, ����� ����� �������, �� � ���� ���� ����� �������� "�����" ��� Null
        -- ������� ����� ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        -- ���� � ���������� ����������� ������ ---------------------------------------------------------------------------------------------------------------
    ...
    UNION 
    SELECT  
        '���������_', 0, '���������', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
    ...
    -- ��������� 6: ������ �� @TableFnIpgChRsltCstUtlPercentBrnRepSrc01_2408 (������ �����, ��� ����������)
    SET @StepTime = SYSDATETIME();
    SET @StepName = '���������� ���������� 6 (������ � ����������� ��������, ������ �����)';
    PRINT @StepName + '...';
    ...
    -- ��������� 7: ������ �� @TableFnIpgChRsltCstUtlPercentBrnRepSrc01_2408 � ����������� WHERE cstAgPnCode = '�����' � UNION
    SET @StepTime = SYSDATETIME();
    SET @StepName = '���������� ���������� 7 (������ � ����������� "�����" � UNION)';
    PRINT @StepName + '...';
    ...
    SELECT  
        ...
        CASE WHEN o.branchName = o.ogNm THEN '����������� ����' ELSE o.branchName END as branchName,  o.lim, o.ag_lim, 
        o.ag_Ful_OverFul, o.ag_LimPc, o.ag_PlOverLimit_, o.iv_lim, o.uk_lim,  
        o.ag_PlAccum, o.ag_PlFulfillment, o.ag_PlPz, o.ag_PlOverFulfillment, o.ag_PlPercent, 
    ...
    WHERE o.cstAgPnCode = '�����'
    UNION SELECT  
        '���������_', 0, '���������', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
    ...
    PRINT '===============================================';
    PRINT '���������� ��������� ���������';
    PRINT '����� ����� ����������: ' + CAST(DATEDIFF(MILLISECOND, @StartTime, SYSDATETIME()) AS nvarchar(20)) + ' ��';
    PRINT '===============================================';
