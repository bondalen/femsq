...
/****** Object:  StoredProcedure [ags].[spMstrg_2408_ipgSt]    Script Date: 16.04.2026 11:59:12 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [ags].[spMstrg_2408_ipgSt] 
	-- Параметры
...
BEGIN
	...
	declare @ipgSt nvarchar(255) = '12ОПР';
	...
	from ags.fnIpgChRsltCstUtlPercentBrn_2408_ipgSt(@ipgCh, @ipgSt)-- f where f.dateRslt = @MounthEndDate странно, увеличивает время с 53 секунд до 1 минуты 26...
	...
	-- 1.2 табличка для столбцов не начинающихся с 'ag', 'iv', 'ia'
