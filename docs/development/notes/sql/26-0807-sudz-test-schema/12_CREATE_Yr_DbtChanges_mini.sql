-- =============================================================================
-- Мини-витрина Rslt на модели test_sudz (заготовка под Yr_DbtChanges)
...
JOIN test_sudz.DbtValue dv ON dv.dvUpl = u.upl_key
...
--    Вызов: EXEC test_sudz.Yr_DbtChanges_mini @yr = 901;
---------------------------------------------------------------------
...
-- smoke
SELECT TOP 5 * FROM test_sudz.vw_Yr_DbtFact ORDER BY dbtKey, as_of;
