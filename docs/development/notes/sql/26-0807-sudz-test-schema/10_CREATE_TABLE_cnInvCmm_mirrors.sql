-- =============================================================================
-- Зеркала комментариев / групп / года в test_sudz
-- FK на долг → test_sudz.Dbt (колонки *InvAccnt сохранены по имени ags-зеркала)
...
-- cnInvCmmGr
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmmGr', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmmGr
    (
...
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvGrNm', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvGrNm
    (
...
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmm', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmm
    (
        ...
        CONSTRAINT FK_cnInvCmm_cnInvCmmGr FOREIGN KEY (cnicGroup)
            REFERENCES test_sudz.cnInvCmmGr (cnicgKey),
...
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmmAg', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmmAg
    (
...
-- cnInvCmmCst
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmmCst', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmmCst
    (
...
-- cnInvCmmDt
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmmDt', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmmDt
    (
...
-- cnInvCmmFn
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvCmmFn', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvCmmFn
    (
...
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.cnInvGr', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.cnInvGr
    (
        ...
        CONSTRAINT FK_cnInvGr_cnInvGrNm FOREIGN KEY (cnigGrName)
            REFERENCES test_sudz.cnInvGrNm (cnignKey),
...
---------------------------------------------------------------------
IF OBJECT_ID(N'test_sudz.yr', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.yr
    (
...
IF OBJECT_ID(N'test_sudz.yr_upl_p', N'U') IS NULL
BEGIN
    CREATE TABLE test_sudz.yr_upl_p
    (
