...
**Живой якорь не split, пока нет S77.1:** `iKey=85166`, КСДД 2807/2808 @901 (2×18 000, `reason=multi`). Черновик DDL на `sudz` (не выполнять): [../26-0908-sudz-split-merge-dev](../26-0908-sudz-split-merge-dev/).
