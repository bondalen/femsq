...
ROLLBACK: MSSQL2012/05_ROLLBACK.sql | SQL Server 2012 SP4+
=============================================================================*/
SET NOCOUNT ON;
PRINT '=== 03: Создание ags.spMstrg_2605 (SQL Server 2012) ===';
...
PRINT 'Применяем CREATE PROCEDURE ags.spMstrg_2605...';
