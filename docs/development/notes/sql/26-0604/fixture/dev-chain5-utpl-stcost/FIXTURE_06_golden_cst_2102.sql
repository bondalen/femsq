...
-- Dev-only: полный UtPl (212/195/172/187 × 12 мес.) для ipgPn 2037, 3290, 5271
-- (cstAgPn=2102) в тестовых группах 18/19/20. Существующие UtPl в группах 3/4/6 не трогаем.
--
-- Профили помесячного распределения @212:
--   2037 (ИП 6, gr 18): равномерно 1/12
--   3290 (ИП 8, gr 19): 25% mn4 + 35% mn7 + 40% mn9
--   5271 (ИП 11, gr 20): 40% mn9 + 60% mn11 (как FIXTURE_05)
-- =============================================================================
SET NOCOUNT ON;
GO
