...
-- =============================================================================
-- Файл:    MSSQL2012/05b_PATCH_PercentBrn_ipgChRl_2606.sql
-- Пакет:   docs/development/notes/sql/26-0604/
-- Совместимость: SQL Server 2012 SP4. Зеркало dev/05b_*.
...
PRINT N'=== 05b: PATCH PercentBrn_2606 plan-JOIN ipgChRl_2606 ===';
GO
									...
									from
										...
										left join
											...
											left join -- для агентской схемы
												...
												left join
													(
														select r.ipgcrvChain AS ipgcrChain, r.ipgcrvIpg AS ipgcrIpg, iuplpIpgPn, iuplpSubAg
														...
														from ags.ipgChRl_2606 r
															join ags.ipgUtPlGr g on r.ipgcrvUtPlGr = g.iuplgKey
											...
											left join -- для инвестиционной схемы
												...
												left join
													(
														select
															r.ipgcrvChain AS ipgcrChain, r.ipgcrvIpg AS ipgcrIpg, iuplpIpgPn, iuplpSubAg
															, iuplpM01, iuplpM02, iuplpM03
															, iuplpM04, iuplpM05, iuplpM06
															, iuplpM07, iuplpM08, iuplpM09
															, iuplpM10, iuplpM11, iuplpM12
...
PRINT N'=== 05b: fnIpgChRsltCstUtlPercentBrn_2606 patched (plan-JOIN ipgChRl_2606) ===';
GO
