...
-- =============================================================================
-- Файл:    MSSQL2012/05a_PATCH_PercentBrn_fnIpgChDats_2606.sql
-- Пакет:   docs/development/notes/sql/26-0604/
-- Назначение: Этап 20.2/20.5 — @dt из fnIpgChDats_2606 + ipgChRl_2606; убрать legacy UNION 01.01.
-- Совместимость: SQL Server 2012 SP4. Зеркало dev/05a_PATCH_PercentBrn_fnIpgChDats_2606.sql
-- Предусловия: 02 (fnIpgChDats_2606), 05 (PercentBrn_2606).
-- Порядок: после 05_CREATE_FUNCTION_fnIpgChRsltCstUtlPercentBrn_2606.sql (или вместо повторного 05).
-- Деплой (multi-statement TVF): DROP отдельно, затем CREATE из строк 33–2814:
--   sqlcmd … -Q "DROP FUNCTION ags.fnIpgChRsltCstUtlPercentBrn_2606;"
--   sed -n '31,2814p' MSSQL2012/05a_PATCH…sql | sqlcmd … -i /dev/stdin
...
PRINT N'=== 05a: PATCH PercentBrn_2606 fnIpgChDats_2606 ===';
GO
...
PRINT N'=== 05a: fnIpgChRsltCstUtlPercentBrn_2606 patched ===';
GO
