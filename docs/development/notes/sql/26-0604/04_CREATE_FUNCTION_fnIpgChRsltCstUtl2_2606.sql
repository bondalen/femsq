...
-- =============================================================================
-- Файл:    04_CREATE_FUNCTION_fnIpgChRsltCstUtl2_2606.sql
...
--   Лимиты и прочий факт (АВ, РАЛП, хранение…) — mastering + ipgChRl_2606.
...
CREATE OR ALTER FUNCTION ags.fnIpgChRsltCstUtl2_2606
(
    @ipgChKey   int,
    @ipgStKey   int = NULL,
    @stCostKey  int = NULL
