-- =============================================================================
-- sudz.invDbtVar — вариант контекста долга (песочница СУДЗ)
-- DEV only. Спецификация: 08-target-schema.md §2.3
-- =============================================================================

IF OBJECT_ID(N'sudz.invDbtVar', N'U') IS NULL
BEGIN
    CREATE TABLE sudz.invDbtVar
    (
...
IF NOT EXISTS (
    ...
    WHERE ep.major_id = OBJECT_ID(N'sudz.invDbtVar')
      AND ep.minor_id = 0
...
WHERE c.object_id = OBJECT_ID(N'sudz.invDbtVar')
