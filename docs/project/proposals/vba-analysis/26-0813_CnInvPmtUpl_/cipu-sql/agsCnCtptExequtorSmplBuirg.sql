-- Access QueryDef: agsCnCtptExequtorSmplBuirg
-- Type: SELECT (0)
-- dumped: 2026-08-17 23:58

SELECT c.cn_key, n.cnnNumNull AS cn_number, s.cn_s_key, s.cn_s_type, os.csosKey, i.org_id_key, i.org_id_type, c.cn_date, i.org_id_value_l, g.ogNm
...
WHERE (((s.cn_s_type)=2) AND ((i.org_id_type)=1));
